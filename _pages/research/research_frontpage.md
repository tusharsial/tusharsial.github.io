      ...
      <div class="opt1-card fade-in">
        ...
        <div class="opt1-body">
          ...
          <div class="opt1-btns">
            ...
            <a href="https://arxiv.org/abs/2603.03479" target="_blank" rel="noopener" class="opt1-btn opt1-btn-ghost"><svg class="opt1-icon"><use href="#ico-doc"/></svg>Preprint</a>
          </div>
        </div>
      </div>
      ...
      <div class="opt1-card fade-in">
        ...
        <div class="opt1-body">
          ...
          <div class="opt1-btns">
            ...
            <a href="/files/AERE-6510-Final-Project-Tushar-Sial.pdf" target="_blank" rel="noopener" class="opt1-btn opt1-btn-ghost"><svg class="opt1-icon"><use href="#ico-doc"/></svg>Report</a>
          </div>
        </div>
      </div>

...
.ring-1 { width: 260px; height: 260px; margin: -280px 0 0 -280px; animation-duration: 30s; }
.ring-2 { width: 400px; height: 400px; margin: -260px 0 0 -260px; animation-duration: 26s; border-color: rgba(255,154,60,0.13); } 
.ring-3 { width: 460px; height: 460px; margin: -230px 0 0 -230px; animation-duration: 20s; border-color: rgba(255,107,0,0.20); }
.o-dot {
  position: absolute;
